    ...
    <div className='container mx-auto px-6 py-8'>
        <div className='grid md:grid-cols-2 gap-8'>
            <div className='space-y-4'>
                <img src={products[13].image} alt="Graphics Card" className='w-full rounded-lg shadow-lg'/>
            </div>
            <div className='bg-white p-6 rounded-lg shadow-lg'>
                <div className='space-y-4'>
                    <h2 className='text-2xl font-bold text-gray-900'>{products[13].name}</h2>
                        <div>
                            {products[13].inStock ?
                            ...
                            <span className='text-3xl font-bold text-gray-900'>Your Price: ${products[13].price}</span>
                        </div>
                </div>
                <div className='space-y-4'>
                        ...
                        <div>
                            <h4 className='font-semibold text-gray-900 mb-2'>Key Features:</h4>
                                <ul className='space-y-2 text-sm'>
                                    <li>• Premium, immersive, high-fidelity audio</li>
                                    <li>• Powerful high-excursion woofer delivers deep, rich bass</li>
                                    <li>• Five beamforming tweeters for clear, detailed highs</li>
                                    <li>• Advanced computational audio delivers room-filling sound</li>
                                    <li>• Spatial Audio for big sound all around</li>
                                    <li>• Create a stereo pair with two HomePod speakers for more immersive listening</li>
                                    <li>• Connect one HomePod speaker or a stereo pair with Apple TV for rich home theater audio</li>
                                    <li>• Works seamlessly with Apple devices; hold iPhone close to HomePod to hand off audio</li>
                                    <li>• Siri is the family’s intelligent assistant, helping with everyday tasks</li>
                                    <li>• Home hub to connect and control smart home accessories</li>
                                    <li>• Designed from the ground up to be private and secure</li>
                                    <li>• Setup requires Wi-Fi and iPhone or iPad with the latest software.</li>
                                </ul>
                        </div>    
                    </div>   
                )}
        ...
        <RecommendedGrids
            currentProductId={products[13].id}
            category={products[13].category}
        />
    </div>
    <Footer/>
    </>
