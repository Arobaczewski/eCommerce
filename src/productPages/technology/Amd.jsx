    ...
    <div className='container mx-auto px-6 py-8'>
        <div className='grid md:grid-cols-2 gap-8'>
            <div className='space-y-4'>
                <img src={products[12].image} alt="Graphics Card" className='w-full rounded-lg shadow-lg'/>
            </div>
            <div className='bg-white p-6 rounded-lg shadow-lg'>
                <div className='space-y-4'>
                    <h2 className='text-2xl font-bold text-gray-900'>{products[12].name}</h2>
                        <div>
                            {products[12].inStock ?
                            ...
                            <span className='text-3xl font-bold text-gray-900'>Your Price: ${products[12].price}</span>
                        </div>
                </div>
                <div className='space-y-4'>
                        ...
                        <div>
                            <h4 className='font-semibold text-gray-900 mb-2'>Key Features:</h4>
                                <ul className='space-y-2 text-sm'>
                                    <li>• 8-core</li>
                                    <li>• 16-Thread</li>
                                    <li>• Up to 5.2GHz Max Boost</li>
                                    <li>• 104 MB total Cache</li>
                                    <li>• 120W TDP</li>
                                </ul>
                        </div>    
                    </div>   
        ...
        <RecommendedGrids
            currentProductId={products[12].id}
