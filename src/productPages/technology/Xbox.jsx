    ...
    <div className='container mx-auto px-6 py-8'>
        <div className='grid md:grid-cols-2 gap-8'>
            <div className='space-y-4'>
                <img src={products[17].image} alt="Graphics Card" className='w-full rounded-lg shadow-lg'/>
            </div>
            <div className='bg-white p-6 rounded-lg shadow-lg'>
                <div className='space-y-4'>
                    <h2 className='text-2xl font-bold text-gray-900'>{products[17].name}</h2>
                        <div>
                            {products[17].inStock ?
                            ...
                            <span className='text-3xl font-bold text-gray-900'>Your Price: ${products[17].price}</span>
                        </div>
                </div>
                <div className='space-y-4'>
            ...
            >
                ...
                {isOpen && (
                    <div className='mt-4 p-6 bg-white border rounded-lg text-gray-700 leading-relaxed space-y-4'>
                        <p>{products[17].description}</p>
                        <div>
                            <h4 className='font-semibold text-gray-900 mb-2'>Key Features:</h4>
                                <ul className='space-y-2 text-sm'>
                                    <li>• Power your dreams</li>
                                    <li>• Play more, wait less</li>
                                    <li>• Watch your favorite entertainment</li>
                                    <li>• Thousands of games ready to play</li>
                                    <li>• Looks better, plays better</li>
                                    <li>• Discover your next favorite game</li>
        ...
        <RecommendedGrids
            currentProductId={products[17].id}
            category={products[17].category}
        />
    </div>
    <Footer/>
    </>
