    ...
    <div className='container mx-auto px-6 py-8'>
        <div className='grid md:grid-cols-2 gap-8'>
            <div className='space-y-4'>
                <img src={products[9].image} alt="Graphics Card" className='w-full rounded-lg shadow-lg'/>
            </div>
            <div className='bg-white p-6 rounded-lg shadow-lg'>
                <div className='space-y-4'>
                    <h2 className='text-2xl font-bold text-gray-900'>{products[9].name}</h2>
                        <div>
                            {products[9].inStock ?
                            ...
                            <span className='text-3xl font-bold text-gray-900'>Your Price: ${products[9].price}</span>
                        </div>
                </div>
                <div className='space-y-4'>
                        ...
                        <div>
                            <h4 className='font-semibold text-gray-900 mb-2'>Key Features:</h4>
                                <ul className='space-y-2 text-sm'>
                                    <li>• 399cc IN-LINE 4-CYLINDER DOHC ENGINE</li>
                                    <li>• RAM AIR DUCT INTAKE SYSTEM</li>
                                    <li>• WORLDSBK-INSPIRED CHASSIS</li>
                                    <li>• ALL-LED LIGHTING</li>
                                    <li>• KAWASAKI TRACTION CONTROL (KTRC)</li>
                                    <li>• Assist & Slipper Clutch</li>
                                    <li>• Dual front disc brakes</li>
                                    <li>• Integrated Riding Modes</li>
                                    <li>• Power Mode Selection</li>
                                    <li>• TFT color instrumentation with circuit mode</li>
                                </ul>
                        </div>    
                    </div>   
                )}
        ...
        <RecommendedGrids
            currentProductId={products[9].id}
            category={products[9].category}
        />
    </div>
    <Footer/>
    </>
