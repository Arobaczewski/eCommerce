    ...
    <div className='container mx-auto px-6 py-8'>
        <div className='grid md:grid-cols-2 gap-8'>
            <div className='space-y-4'>
                <img src={products[8].image} alt="Graphics Card" className='w-full rounded-lg shadow-lg'/>
            </div>
            <div className='bg-white p-6 rounded-lg shadow-lg'>
                <div className='space-y-4'>
                    <h2 className='text-2xl font-bold text-gray-900'>{products[8].name}</h2>
                        <div>
                            {products[8].inStock ?
                            ...
                            <span className='text-3xl font-bold text-gray-900'>Your Price: ${products[8].price}</span>
                        </div>
                </div>
                <div className='space-y-4'>
                        ...
                        <div>
                            <h4 className='font-semibold text-gray-900 mb-2'>Key Features:</h4>
                                <ul className='space-y-2 text-sm'>
                                    <li>• 3 Machines In 1</li>
                                    <li>• Barista Assist Technology</li>
                                    <li>• Integrated Grinder</li>
                                    <li>• Weight-Based Dosing</li>
                                    <li>• Hands-Free Frothing</li>
                                    <li>• Temperature Settings</li>
                                    <li>• Flavorful Cold-Pressed Drinks</li>
                                    <li>• Perfect Pucks</li>
                                    <li>• Built-In Storage</li>
                                    <li>• Espresso Uncomplicated</li>
                                </ul>
                        </div>    
                    </div>   
                )}
        ...
        <RecommendedGrids
            currentProductId={products[8].id}
