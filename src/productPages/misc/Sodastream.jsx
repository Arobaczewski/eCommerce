    ...
    <div className='container mx-auto px-6 py-8'>
        <div className='grid md:grid-cols-2 gap-8'>
            <div className='space-y-4'>
                <img src={products[11].image} alt="Graphics Card" className='w-full rounded-lg shadow-lg'/>
            </div>
            <div className='bg-white p-6 rounded-lg shadow-lg'>
                <div className='space-y-4'>
                    <h2 className='text-2xl font-bold text-gray-900'>{products[11].name}</h2>
                        <div>
                            {products[11].inStock ?
                            ...
                            <span className='text-3xl font-bold text-gray-900'>Your Price: ${products[11].price}</span>
                        </div>
                </div>
                <div className='space-y-4'>
                        ...
                        <div>
                            <h4 className='font-semibold text-gray-900 mb-2'>Key Features:</h4>
                                <ul className='space-y-2 text-sm'>
                                    <li>• Easy to use</li>
                                    <li>• Makes hydration fun!</li>
                                    <li>• Household favorite flavors</li>
                                    <li>• Custom Carbonation</li>
                                    <li>• Eco-friendly</li>
                                    <li>• Refillable CO2</li>
                                </ul>
                        </div>    
                    </div>   
                )}
        ...
        <RecommendedGrids
            currentProductId={products[11].id}
            category={products[11].category}
        />
    </div>
    <Footer/>
    </>
