    ...
    <div className='container mx-auto px-6 py-8'>
        <div className='grid md:grid-cols-2 gap-8'>
            <div className='space-y-4'>
                <img src={products[10].image} alt="Graphics Card" className='w-full rounded-lg shadow-lg'/>
            </div>
            <div className='bg-white p-6 rounded-lg shadow-lg'>
                <div className='space-y-4'>
                    <h2 className='text-2xl font-bold text-gray-900'>{products[10].name}</h2>
                        <div>
                            {products[10].inStock ?
                            ...
                            <span className='text-3xl font-bold text-gray-900'>Your Price: ${products[10].price}</span>
                        </div>
                </div>
                <div className='space-y-4'>
                        ...
                        <div>
                            <h4 className='font-semibold text-gray-900 mb-2'>Key Features:</h4>
                                <ul className='space-y-2 text-sm'>
                                    <li>• No Ice Needed</li>
                                    <li>• A Superior Frozen Drink Experience</li>
                                    <li>• One-Touch Frozen Drinks</li>
                                    <li>• Hack Your Sugar-Free Recipes</li>
                                    <li>• Self-Serve Handle With Pour Spout</li>
                                    <li>• 5 Preset Settings</li>
                                    <li>• Temperature Control</li>
                                    <li>• Easy-Fill Vessel</li>
                                    <li>• Hassle-Free Cleanup</li>
                                    <li>• Whisperchill Compressor</li>
                                </ul>
                        </div>    
                    </div>   
                )}
        ...
        <RecommendedGrids
            currentProductId={products[10].id}
