    ...
    <div className='container mx-auto px-6 py-8'>
        <div className='grid md:grid-cols-2 gap-8'>
            <div className='space-y-4'>
                <img src={products[1].image} alt="Cole Palmer Jersey" className='w-full rounded-lg shadow-lg'/>
            </div>
            <div className='bg-white p-6 rounded-lg shadow-lg'>
                <div className='space-y-4'>
                    <h2 className='text-2xl font-bold text-gray-900'>{products[1].name}</h2>
                        <div>
                            {products[1].inStock ?
                            ...
                            <span className='text-3xl font-bold text-gray-900'>Your Price: ${products[1].price}</span>
                        </div>
                </div>
                <div className='space-y-4'>
        ...
        <RecommendedGrids
            currentProductId={products[1].id}
